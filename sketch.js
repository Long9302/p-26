...
function handleComputerArrowCollision() {
  ...
  for (var i = 0; i < computerArrows.length;i++){
    var computerbaseCollision = Matter.SAT.collides(computerArrows[i].body,playerBase.body);
  
    var computerarcherCollision = Matter.SAT.collides(computerArrows[i].body,playerArcher.body);
  
    var playerCollision = Matter.SAT.collides(computerArrows[i].body,player.body);
  
    if(computerbaseCollision.collided||computerarcherCollision.collided||playerCollision.collided){
